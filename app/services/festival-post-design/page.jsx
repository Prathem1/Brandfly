...
const logos = [
    '/services/festival/festival1.png',
    '/services/festival/festival2.png',
            ...
            <div className="w-full text-left px-4 sm:px-6 md:px-[1cm]">
                <div className="py-3 sm:py-4 mb-4">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 ">
                        Festive Post Designs That Celebrate with Purpose
                    </h1>
                </div>
                <p className="text-gray-600 text-sm sm:text-base md:text-lg max-w-full sm:max-w-[90%] md:max-w-[70%]">
                    We create culturally rich, brand-aligned festival posts that capture the spirit of celebration while keeping
                    your brand voice consistent. Designed to engage, inspire, and connect, each post strengthens your presence
                    during key festive moments.
                </p>
            </div>
