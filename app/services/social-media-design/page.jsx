...
const logos = [
    '/services/socialmedia/social1.png',
   '/services/socialmedia/social2.png',
   '/services/socialmedia/social3.png',
           ...
           <div className="w-full text-left px-4 sm:px-6 md:px-[1cm]">
                <div className="py-3 sm:py-4 mb-4">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">
                        Impactful Social Media Design That Captures Attention
                    </h1>
                </div>
                <p className="text-gray-600 text-sm sm:text-base md:text-lg max-w-full sm:max-w-[90%] md:max-w-[70%]">
                    We create visually compelling and brand-aligned social media content that drives engagement and consistency across platforms.
                    Our designs are crafted to elevate your online presence, strengthen recognition, and connect meaningfully with your audience.
                </p>
            </div>
